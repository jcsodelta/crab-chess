...
* @param {Node} parent
*/
export function game_page_component(parent) {
    wasm.game_page_component(addHeapObject(parent));
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_instanceof_Comment_f601583e14c1b74e = function(arg0) {
        let result;
        try {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('storybook_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
